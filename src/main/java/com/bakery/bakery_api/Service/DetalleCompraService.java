...
public class DetalleCompraService {
    ...
    public DetalleCompra create(CreateDetalleCompraDTO dto) {
        ...
        detalle.setCompra(compraService.findById(dto.compraId()));  // valida que exista la compra
        detalle.setProducto(productoService.findById(dto.productoId()));  // valida que exista el producto
    ...
    public DetalleCompra update(Long id, UpdateDetalleCompraDTO dto) {
        ...
        if (dto.cantidad() != null) existing.setCantidad(dto.cantidad());
