# ADR 0008: Typed Configuration + Production Fail-Fast Checks
...
- Use `@ConfigurationProperties` records for application configuration (JWT, CORS, rate limit, datasource, JPA).
